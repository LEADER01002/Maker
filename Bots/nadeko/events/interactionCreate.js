...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const nadeko = require(`../../../tokens/tokens.json`)
const client15 = require(`../nadeko-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client15;
		const command = interaction.client15.nadekoSlashCommands.get(interaction.commandName);
