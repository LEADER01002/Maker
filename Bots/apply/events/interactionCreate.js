...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const apply = require(`../../../tokens/tokens.json`)
const client13 = require(`../apply-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client13;
		const command = interaction.client13.ApplySlashCommands.get(interaction.commandName);
