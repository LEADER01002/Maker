...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const credit = require(`../../../tokens/tokens.json`)
const client16 = require(`../credit-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client16;
		const command = interaction.client16.creditSlashCommands.get(interaction.commandName);
