...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const probot = require(`../../../tokens/tokens.json`)
const client9 = require(`../probot-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client9;
		const command = interaction.client9.probotSlashCommands.get(interaction.commandName);
