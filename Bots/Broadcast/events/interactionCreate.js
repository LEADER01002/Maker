...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const Bc = require(`../../../tokens/tokens.json`)
const client2 = require(`../Broadcast-Bots.js`)
module.exports = {
  ...
  async execute(interaction){
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
		...
		const command = interaction.client2.BcSlashCommands.get(interaction.commandName);
