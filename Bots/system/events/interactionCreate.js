...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const system = require(`../../../tokens/tokens.json`)
const client17 = require(`../system-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client17;
		const command = interaction.client17.systemSlashCommands.get(interaction.commandName);
