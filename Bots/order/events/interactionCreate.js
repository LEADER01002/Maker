...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const order = require(`../../../tokens/tokens.json`)
const client17 = require(`../order-Bots.js`)
module.exports = {
  ...
  async execute(interaction){
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
		...
		const command = interaction.client17.orderSlashCommands.get(interaction.commandName);
