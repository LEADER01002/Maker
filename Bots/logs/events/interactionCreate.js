...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const logs = require(`../../../tokens/tokens.json`)
const client6 = require(`../logs-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client6;
		const command = interaction.client6.logsSlashCommands.get(interaction.commandName);
