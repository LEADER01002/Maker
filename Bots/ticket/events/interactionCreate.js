...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const ticket = require(`../../../tokens/tokens.json`)
const client7 = require(`../ticket-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client7;
		const command = interaction.client7.ticketSlashCommands.get(interaction.commandName);
