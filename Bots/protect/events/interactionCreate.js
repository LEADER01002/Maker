...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const protect = require(`../../../tokens/tokens.json`)
const client19 = require(`../protect-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client19;
		const command = interaction.client19.protectSlashCommands.get(interaction.commandName);
