...
*/const { Events, Interaction, EmbedBuilder ,InteractionType } = require('discord.js');
const { Database } = require("st.db")
const tax = require(`../../../tokens/tokens.json`)
const client3 = require(`../Tax-Bots.js`)
module.exports = {
    ...
    if (interaction.isChatInputCommand()) {
      console.log('tst2')
	    if(interaction.user.bot) return;
	     let client = interaction.client3;
		const command = interaction.client3.taxSlashCommands.get(interaction.commandName);
